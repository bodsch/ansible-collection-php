"""
Helpers to render and write PHP module configuration files idempotently.
"""
...
from ansible_collections.bodsch.php.plugins.module_utils.php_dataclasses import ModuleDefinition
...
class PhpModule:
    """Render and write a single PHP module configuration file."""
    ...
    def write_module_configuration(
        ...
        Args:
            module_definition: Module definition providing the logical name and
